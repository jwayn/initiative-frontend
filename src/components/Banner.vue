<template>
    <header class="banner h-16 sm:h-12 bg-gray-300 sm:flex sm:justify-between p-2 sm:px-4 sm:py-3 sm:items-center fixed sm:static left-0 sm:left-auto top-0 sm:top-auto w-full">
        ...
        <div @click="menuOpen = false" :class="menuOpen ? 'block' : 'hidden'" class="px-4 pt-1 pb-4 sm:flex sm:p-0 absolute left-0 sm:right-1 sm:left-auto bg-gray-300 w-full sm:w-auto border-b-2 sm:border-none border-green-700">
            ...
            <router-link v-if="isSignedIn" to="/account" class="block text-gray-800 font-semibold p-2 mt-1 text-md hover:bg-gray-200 rounded sm:mt-0 sm:ml-2">Account</router-link>
