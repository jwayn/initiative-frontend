<template>
  <div class="flex flex-col pb-3 pl-3 pr-3 overflow-y-hidden actor-full-data" :style="{maxHeight: showEditActor ? '1400px' : '500px'}">
    ...
    <transition name="color-fade" mode="out-in">
      ...
      <EditTrackerActor v-on:closeEditActor="showEditActor = false" :propsActor="actor" v-else />
    </transition>
...
<script>
import EditTrackerActor from './EditTrackerActor';
export default {
  components: {
    EditTrackerActor,
  },
